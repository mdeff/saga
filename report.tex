...
\usepackage[top=3.0cm,bottom=1.5cm,left=2cm,right=2cm,headheight=30pt]{geometry}
...
\begin{figure*}[ht]
	...
	\subfigure[Working memory to store gradients.]{
		\label{fig:memory}
		\includegraphics[height=3cm,width=8cm]{memory}}
	\hspace{0pt}
	\subfigure[$R^2$ score on test set after 100s training.]{
		\label{fig:r2_score}
		\includegraphics[height=3cm,width=8cm]{r2_score}}
	\\
	\subfigure[Objective w.r.t. running time.]{
		\label{fig:perf}
		\includegraphics[height=4cm,width=12cm]{perf}}
...
\begin{figure*}[ht]
	\centering
	\subfigure[First approach]{\label{2figs-show-a}
	\includegraphics[height=3cm,width=0.48\columnwidth]{Picture2.png}}
	\hspace{0pt}
	\subfigure[Second approach]{\label{2figs-show-b}
	\includegraphics[height=3cm,width=0.48\columnwidth]{Picture1.png}}
...
\begin{figure*}[ht]
	\centering
	\subfigure[Learning rate in the first approach]{\label{3figs-a} \includegraphics[width=0.31\columnwidth]{distributed1.eps}} \hspace{0pt}
	\subfigure[Different kind of parallelization in the second approach]{\label{3figs-b} \includegraphics[width=0.31\columnwidth]{distributed2.eps}} \hspace{0pt}
	\subfigure[Learning rate in the second approach]{\label{3figs-c} \includegraphics[width=0.31\columnwidth]{distributed3.eps}}
...
\begin{figure*}[ht]
	\centering
	\subfigure[Convergence in terms of iteration]{\label{2figs-a} \includegraphics[width=0.31\columnwidth]{compare.eps}} \hspace{0pt}
	\subfigure[Convergence in terms of simulation time]{\label{2figs-b} \includegraphics[width=0.31\columnwidth]{compare2.eps}}
