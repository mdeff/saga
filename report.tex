...
\begin{figure*}[ht]
	...
	\subfigure[Working memory to store gradients.]{
		\label{fig:memory}
		\includegraphics[height=3cm,width=8cm]{figs/memory}}
	\hspace{0pt}
	\subfigure[$R^2$ score on test set after 100s training.]{
		\label{fig:r2_score}
		\includegraphics[height=3cm,width=8cm]{figs/r2_score}}
	\\
...
\begin{figure*}[ht]
	...
	\subfigure[Variant I: learning rate.]{
		\label{fig:arch1_lr}
		\includegraphics[width=0.31\columnwidth]{figs/arch1_lr}}
	\hspace{0pt}
	\subfigure[Variant II: different parallelizations.]{
		\label{fig:arch2_par}
		\includegraphics[width=0.31\columnwidth]{figs/arch2_par}}
	\hspace{0pt}
	\subfigure[Variant II: learning rate.]{
		\label{fig:arch2_lr}
		\includegraphics[width=0.31\columnwidth]{figs/arch2_lr}}
...
\begin{figure*}[ht]
	...
	\subfigure[Convergence w.r.t. the number of iterations.]{
		...
		\includegraphics[width=0.31\columnwidth]{figs/conv_iterations}}
	\hspace{0pt}
	\subfigure[Convergence w.r.t. running time.]{
		\label{fig:conv_time}
		\includegraphics[width=0.31\columnwidth]{figs/conv_time}}
