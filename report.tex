...
%\begin{figure*} [bt]
%	\centering
%	\subfigure[$N=10$ training samples]{\label{2figs-a} \includegraphics[width=0.48\columnwidth]{compare.eps}} \hspace{0pt}
%	\subfigure[$N=100$ training samples]{\label{2figs-b} \includegraphics[width=0.48\columnwidth]{compare2.eps}}
%	\caption{Out-of-sample performance (solid blue line) and the average CCR (dashed red line)}
%	\label{2figs}
%\end{figure*}
